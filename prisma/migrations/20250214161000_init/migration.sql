...
CREATE TABLE "UpadtePoint" (
    ...
    CONSTRAINT "UpadtePoint_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UpadtePoint" ADD CONSTRAINT "UpadtePoint_updateId_fkey" FOREIGN KEY ("updateId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
